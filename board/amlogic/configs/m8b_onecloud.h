...
//南美洲
// =============================================================================
 #定义 CONFIG_CONS_INDEX	        (       2      )
// =============================================================================



// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//加勒比国家联盟:复员方案主计长和系统规划系统设置
// =============================================================================
#定义 配置件
      #IFDEF 配置件
	//将内存大小从SPL传递到UBIN
	 #定义 CONFIG_DDR_SIZE_IND_ADDR	    (   0xD9000000  )
#恩迪夫
// =============================================================================
...
//安全靴
// =============================================================================
#定义 CONFIG_AML_DISABLE_CRYPTO_UBOOT
